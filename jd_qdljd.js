/*
基于faker库的通天塔脚本，仅替换活动地址
签到领京豆--连续签到赢好礼
脚本更新时间：2022-1-3 14:20
脚本兼容: Node.js
===========================
[task_local]
#签到领京豆--连续签到赢好礼
3 0 * * * jd_qdljd.js, tag=签到领京豆--连续签到赢好礼, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
 */

const $ = new Env('签到领京豆--连续签到赢好礼');
...
async function jdsign() {
  try {
    console.log(`签到开始........`)
    await getInfo("https://prodev.m.jd.com/mall/active/whyxjHX23eNgT6Xvej19JnamfEH/index.html");//签到领京豆--连续签到赢好礼
  } catch (e) {
    $.logErr(e)
  }
